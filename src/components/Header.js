...
const Header = () => {
  return (
    <div className="sticky bg-[#353b48] z-10 header top-0 text-3xl flex justify-between items-center text-[#e84118] font-bold  p-3 border-b-2 border-[#7f8fa6] rounded-3xl">
      <Link to={"/"}>
        <span>
